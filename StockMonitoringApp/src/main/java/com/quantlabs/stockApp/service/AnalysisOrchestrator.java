...
public class AnalysisOrchestrator {
	...
	public static LinkedHashMap<String, AnalysisResult> analyzeSymbolReComputeCustomIndicator(String symbol, Set<String> timeframes,
		...
		for (String timeframe : timeframes) {
			...
			if ((hasStandardIndicators || hasCustomIndicators) && !results.isEmpty()) {
				try {
					// Apply uptrend filter if enabled
					if (uptrendFilterEnabled && previousTimeframeConsensusStatus != null) {
						if (previousTimeframeConsensusStatus == null
	...
	public static void setTechnicalAnalysisService(TechnicalAnalysisService technicalAnalysisService) {
		AnalysisOrchestrator.technicalAnalysisService = technicalAnalysisService;
	}
	...
	public static void setDataProvider(StockDataProvider dataProvider) {
		AnalysisOrchestrator.dataProvider = dataProvider;
	}
